  ...
  <div class="task-table my-5">
    ...
    >
      <div class="wrapping-text flex">
        <div
          class="wrapping-color-box h-4 w-4 bg-[#FDE400] border border-[#929292] m-3 py-1.5"
        ></div>
        <div class="wrapping-status py-1.5 text-white font-bold">
           {{this.$store.state.lang==='en'?'On Progress':'تحت الاجراء'}}
        </div>
      </div>
      <div class="wrapping-right-items flex justify-between">
        <div class="wrapping-no-of-tasks mt-2 text-black font-semibold border border-black w-6 h-5 bg-white pb-6 rounded-lg">3</div>
        <div class="wrapping-arrow py-1.5 px-2">
          <svg
