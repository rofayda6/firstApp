  ...
  <div class="task-table my-5">
    ...
    >
      <div class="wrapping-text flex">
        <div
          class="wrapping-color-box h-4 w-4 bg-[#E98E05] border border-[#929292] m-3 py-1.5"
        ></div>
        <div class="wrapping-status py-1.5 text-white font-bold">{{this.$store.state.lang==='en'?'Done':'تم'}}</div>
      </div>
